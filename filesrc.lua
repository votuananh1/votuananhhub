...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Võ Tuấn Anh Hub chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Võ Tuấn Anh Hub", HidePremium = false, IntroText = "Võ Tuấn Anh Hub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})



OrionLib:MakeNotification({
    Name = "Võ Tuấn Anh Hub",
...
W:AddLabel("Võ Tuấn Anh Hub SCRIPT")
W:AddLabel("DiscordVõ Tuấn Anh Hub")
local Section = W:AddSection({
    Name = "Status"
})
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Võ Tuấn Anh Hub(Noitification)",
